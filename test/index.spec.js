...
const HtmlWebpackOverridePublicPathPlugin = require('../index');
...
const webpackOptions = {
  entry: {
    index: join(__dirname, './test_data/entry.js'),
    online: join(__dirname, './test_data/entry.js')
    // styles: join(__dirname, './test_data/entry.css')
  },
  output: {
    path: OUTPUT_DIR,
    publicPath: '/test_dist/'
  },
  module: {
    rules: [
      {
...
const HtmlWebpackPluginIndexOptions = {
  ...HtmlWebpackPluginOptions,
  chunks: ['index', 'lazy'],
  filename: 'index.html'
};

const HtmlWebpackPluginOnlineOptions = {
  ...HtmlWebpackPluginOptions,
  chunks: ['online', 'lazy'],
  publicPath: 'http://etatetea.com/test/test_dist/',
...
describe('HtmlWebpackOverridePublicPathPlugin', () => {
  // afterEach((done) => {
  ...
  it('should auto append params to css and js', (done) => {
    webpack({ ...webpackOptions,
      plugins: [
        new HtmlWebpackPlugin(HtmlWebpackPluginIndexOptions),
        new HtmlWebpackPlugin(HtmlWebpackPluginOnlineOptions),
        new HtmlWebpackOverridePublicPathPlugin(),
